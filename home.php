...
<html lang="en">
  <head>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Michroma|Montserrat|Raleway&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div style="background-color:black; height:50vh;" class="container-fluid">
          <div class="col-md">
